  ...
  en: {
    ...
    features: {
      ...
      items: [
        ...
        { title: "Community chatrooms", jp: "コミュニティ", desc: "Practice for real. Join topic rooms, attend events with native speakers, and grow alongside fellow learners." },
    ...
    community: {
      ...
      cards: [
        { title: "Community chatrooms", desc: "Public, private, community and scheduled topic rooms — with reactions, replies, mute and host controls." },
        { title: "Live events with native speakers", desc: "Join community events with native speakers and guests. RSVP and add them straight to your calendar." },
