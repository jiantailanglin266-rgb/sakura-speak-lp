...
import AnimeLearning from "@/components/dashboard/AnimeLearning";
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        ...
        <main className="mx-auto w-full max-w-5xl flex-1 px-4 pb-28 pt-6 sm:px-6 lg:pb-10">
          <div className="mb-5 flex items-center gap-3">
            ...
            <div>
              <h1 className="font-display text-2xl font-extrabold text-ink">Anime Learning 🎬</h1>
              <p className="text-sm text-ink-soft">Learn Japanese through official anime videos.</p>
            </div>
          </div>
